import svgPaths from "./svg-are6q647vg";
...
function Span2() {
  return (
    <div className="absolute border-[0.8px] border-[rgba(0,0,0,0.13)] border-solid h-[24.488px] left-[326.2px] rounded-[100px] top-0 w-[133.637px]" data-name="span">
      <p className="absolute font-['Raleway:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[14.88px] left-[12px] text-[#4b4b4b] text-[10px] top-[3.8px] whitespace-nowrap">✓ с 2015 года на рынке</p>
    </div>
  );
}
...
function Span3() {
  return (
    <div className="absolute border-[0.8px] border-[rgba(0,0,0,0.13)] border-solid h-[24.488px] left-[467.84px] rounded-[100px] top-0 w-[179.887px]" data-name="span">
      <p className="absolute font-['Raleway:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[14.88px] left-[12px] text-[#4b4b4b] text-[10px] top-[3.8px] whitespace-nowrap">✓ 200+ реализованных объектов</p>
    </div>
  );
}
...
function Span4() {
  return (
    <div className="absolute border-[0.8px] border-[rgba(0,0,0,0.13)] border-solid h-[24.488px] left-[655.72px] rounded-[100px] top-0 w-[219.262px]" data-name="span">
      <p className="absolute font-['Raleway:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[14.88px] left-[12px] text-[#4b4b4b] text-[10px] top-[3.8px] whitespace-nowrap">✓ официальные дистрибьюторы заводов</p>
    </div>
  );
}
...
function Text20() {
  return (
    <div className="h-[15.6px] relative shrink-0 w-[7.8px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Raleway:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[15.6px] left-0 text-[10.4px] text-white top-[0.6px] whitespace-nowrap">✓</p>
      </div>
    </div>
  );
}
